...
class LockOcupado(OSError):
    pass


class lock_configuracao:
    def __init__(self, workspace):
        ...
        self.caminho = estado / "neoprumo" / "locks" / f"configuracao-{digest}.lock"
        self.arquivo = None
    ...
    def __enter__(self):
        ...
        try:
            ...
            self.arquivo.close()
            raise LockOcupado("Outra gravação da configuração está em andamento.") from erro
        return self
