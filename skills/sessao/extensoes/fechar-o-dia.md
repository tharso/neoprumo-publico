...
Apresentar `problemas` e `acoes` como aviso de saúde em paralelo. Com `total == 0`, despedir-se de modo simples, sem perguntar sobre diário. Com `total > 0`, dizer brevemente que há fatos do dia e oferecer registrá-los. Só com o aceite conduzir pela skill `fim`.
